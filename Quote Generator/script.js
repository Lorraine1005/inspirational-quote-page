...
const generatQuoteBtn = document.getElementById("generate-quote-btn");
const quoteDisplayEl = document.getElementById("quote-display-el");

generatQuoteBtn.addEventListener("click", function () {
  let randomIndex = Math.floor(Math.random() * quotes.length);
  quoteDisplayEl.textContent = quotes[randomIndex];
});
window.onload = function () {
  document.getElementById("mixkit.wav").play();
};
